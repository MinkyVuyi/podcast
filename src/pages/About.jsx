...
function About() {
  return (
    <div className="about-page-container">
      <img src="https://rachelcorbett.com.au/wp-content/uploads/2018/07/Neon-podcast-logo.jpg" alt="Podcast Logo" className="about-hero-image img-fluid" />
      ...
      <div className="about-page-cta">
        ...
        <Link className="btn btn-primary explore-button" to="/vans">Discover our Latest Episodes</Link>
      </div>
    </div>
  );
}
